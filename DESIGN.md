...
The review history, in order, with what each round changed for an installed
user. Any install updated after 2026-09-11 has all of it.
...
and new script side by side (see "What has been tested"); no upgrade step is
needed for it.
